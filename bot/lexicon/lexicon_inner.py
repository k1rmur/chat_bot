...
LEXICON_RU: dict[str, str] = {
    ...
    'Водный реестр': ['''Оптимизированный стандарт и Описание целевого состояния:\nГосударственный водный реестр.''', None, ['/app/documents/ОС2 ГВР 19.04.24.pdf', '/app/documents/ОЦС2 ГВР 26.05.24.pdf']],
    '''Право пользования''': ['''Оптимизированный стандарт и Описание целевого состояния:\nПраво пользования водными объектами''', None, ['/app/documents/ОС2 Решения 22.07.2024.pdf', '/app/documents/ОЦС2 Решения 26.04.24.pdf']],
    'Договоры': ['''Оптимизированный стандарт и Описание целевого состояния:\nДоговоры водопользования''', None, ['/app/documents/ОС2 Договор 22.07.2024.pdf', '/app/documents/ОЦС2 Договор 15.06.24.pdf']],
    'Земельный участок': ['''Оптимизированный стандарт и Описание целевого состояния:\nЗемельный участок на водном объекте''', None, ['/app/documents/ОС2 ИЗУ 22.07.2024.pdf', '/app/documents/ОЦС2 ИЗУ 26.05.24.pdf']],
    'Допустимые нормы': ['''Оптимизированный стандарт и Описание целевого состояния:\nДопустимые нормы веществ и микроорганизмов''', None, ['/app/documents/ОС2 НДС 22.07.2024.pdf', '/app/documents/ОЦС2 НДС 26.04.24.pdf']],
