...
LEXICON_RU: dict[str, str] = {
    "🌊 О боте": ["""Добро пожаловать в официальный ВК-бот Росводресурсов! 🌊
...
Спасибо, что выбрали нас! 💧""", general_menu(),[]],
...
2) внесение изменений в приказ об утверждении нормативов допустимых сбросов веществ и микроорганизмов.''', None, []],
    "📞 Прием граждан": ['''Если вы хотите записаться на личный прием к сотрудникам Росводресурсов, обратитесь к сервису Прием граждан: external-services.favr.ru. 
...
💻 Сайт Росводресурсов: https://voda.gov.ru''', None, []],
    ...
    "🤖 ИИ Собеседник": ['''Добро пожаловать в чат с искусственным интеллектом! Спрашивайте обо всем, что вас интересует, и я постараюсь ответить!''', None, []],
}

LEXICON_COMMANDS_RU = {
    '/start': ['''Добро пожаловать в официальный ВК-бот Росводресурсов! 🌊
