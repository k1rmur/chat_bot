...
2) внесение изменений в приказ об утверждении нормативов допустимых сбросов веществ и микроорганизмов.''', None, []],
    'Прием граждан': ['''Если вы хотите записаться на личный прием к сотрудникам Росводресурсов, обратитесь к сервису ["Прием граждан"](https://external-services.favr.ru/). 
...
Мы рады приветствовать вас и готовы помочь вам с любыми вопросами, связанными с водными ресурсами России. Этот бот использует искусственный интеллект, чтобы предоставлять наиболее точную и актуальную информацию. 

Здесь вы можете:
•	Записаться на личный прием в Росводресурсы;
•	Получить информацию из открытых источников;
•	Подать заявление на ГосУслугах;
•	Получить ответы на все вопросы, связанные с водными ресурсами России.
