...
LEXICON_RU: dict[str, str] = {
    "🌊 О боте": ["""🌊 AI FAVR bot - ИИ-бот, который расскажет о водных ресурсах России, проконсультирует по вопросам оказания госуслуг
...
2) внесение изменений в приказ об утверждении нормативов допустимых сбросов веществ и микроорганизмов.''', None, []],
    "📞 Прием граждан": ['''Если вы хотите записаться на личный прием к сотрудникам Росводресурсов, обратитесь к сервису <a href="https://external-services.favr.ru/">Прием граждан</a>. 

Если вы хотите подать обращение, обратитесь к сервису обратной связи - <a href="https://pos.gosuslugi.ru/form/?opaId=348141&utm_source=vk3&utm_medium=1323055&utm_campaign=1022900545183">ПОС</a>.  
...
LEXICON_COMMANDS_RU = {
    '/start': ['''Добро пожаловать в официальный телеграмм-бот Росводресурсов! 🌊
