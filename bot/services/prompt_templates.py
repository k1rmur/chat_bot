...
QA_PROMPT_STR = (
    ...
    "ответь на вопрос: {query_str}\n. Если в контексте нет ответа, ответь самостоятельно. Не сообщай имя файла, откуда взял информацию и не добавляй лишних коментариев, например 'в контексте указано, что'."
)
