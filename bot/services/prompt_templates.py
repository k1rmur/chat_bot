...
QA_PROMPT_STR = (
    ...
    "ответь на вопрос: {query_str}\n. Отвечай на вопрос в любом случае, не пиши, что данных нет в контексте. Не сообщай имя файла, откуда взял информацию и не добавляй лишних коментариев, например 'в контексте указано, что'."
)
