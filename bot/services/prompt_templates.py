...
QA_PROMPT_STR = (
    ...
    "ответь на вопрос: {query_str}\n. Не сообщай имя файла, откуда взял информацию и не добавляй лишних коментариев, например 'в контексте указано, что'. Если в контексте нет ответа или человек задаёт слишком высокоуровневый запрос, объясни, что ты не можешь отвечать на такие вопросы, а разработан на ответы на более точные вопросы."
)
